...
const MAP = {
  ...
  Italic_completa: require("./schemas/Italic_completa.js"),
...
const MANIFEST = [
  ...
  { key: "Italic_completa", label: "Italic completa — manoscritto dopo estratto", hint: "Carica il manoscritto completo e, nelle comunicazioni precedenti, il feedback dato sull'estratto. Valutazione finale post-estratto." },
